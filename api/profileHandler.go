...
func PostProfile(c *gin.Context) {
	...
	query := "INSERT INTO profiles (app_language, country, city, age, pref_position, playing_frequency, tg_user_id) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id"
	log.Println("Выполняется запрос: ", query)

	var profileID int64
	err = tx.QueryRow(c.Request.Context(), query, input.AppLanguage, input.Country, input.City, input.Age, input.PrefPosition, input.PlayingFrequency, tguserID).Scan(&profileID)
	if err != nil {
